...
- (void)jsq_configureMessagesViewController
{
    ...
    self.inputToolbar.contentView.textView.placeHolder = NSLocalizedString(@"Wait, here users will type and keyboard go up", @"Placeholder text for the message input text view");
